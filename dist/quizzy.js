...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/quizzy.js");
/******/ })
/************************************************************************/
/******/ ({
...
function create_each_block$(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*quiz_data*/ 1 && t0$_value$ !== (t0$_value$ = /*answer*/ ctx[2]["text"] + "")) Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["set_data"])(t0$, t0$_value$);
		},
		d(detaching) {
...
function create_fragment(ctx) {
	...
	let t2$;
	let h3$;
	let t3$_value$ = /*quiz_data*/ ctx[0][current_block]["data"]["question"] + "";
	let t3$;
	let t4$;
	let each$_anchor$;
	let each_value$ = /*quiz_data*/ ctx[0][current_block]["data"]["answers"];
	let each_blocks$ = [];
	...
	return {
		c() {
			...
			h2$.textContent = `Quiz with id: ${/*id*/ ctx[1]}`;
		...
		p(ctx, [dirty]) {
			if (dirty & /*quiz_data*/ 1 && t3$_value$ !== (t3$_value$ = /*quiz_data*/ ctx[0][current_block]["data"]["question"] + "")) Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["set_data"])(t3$, t3$_value$);

			if (dirty & /*quiz_data, current_block*/ 1) {
				each_value$ = /*quiz_data*/ ctx[0][current_block]["data"]["answers"];
				let i;
...
function instance$($$self, $$props, $$invalidate) {
	let id = uuid__WEBPACK_IMPORTED_MODULE_2___default()();
	let { quiz_data } = $$props;

	$$self.$$set = $$props => {
		if ("quiz_data" in $$props) $$invalidate(0, quiz_data = $$props.quiz_data);
	};
...
class Quiz$ extends svelte_internal__WEBPACK_IMPORTED_MODULE_0__["SvelteComponent"] {
	constructor(options) {
		...
		Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["init"])(this, options, instance$, create_fragment, svelte_internal__WEBPACK_IMPORTED_MODULE_0__["safe_not_equal"], { quiz_data: 0 });
	}
}
...
const init = function() {
    ...
    for (let node of nodes) {        
        ...
        let quiz = new _app_Quiz_svelte__WEBPACK_IMPORTED_MODULE_2__["default"]({
            target: node,
            props: {
                quiz_data: quiz_data
            }
...
/* harmony default export */ __webpack_exports__["default"] = (quizzy);
