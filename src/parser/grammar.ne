...
## multiple choice
multiple_choice -> question task_list           {% (data) => to_dict(data, type="multiple-choice") %}
...
## sequence
sequence -> question ordered_list               {% (data) => to_dict(data, type="sequence") %}
ordered_list -> ordered_list_entry:+            
ordered_list_entry -> digit string _            {% ([digit, string, _]) => string %}

## pairs
pairs -> question pair_list                     {% (data) => to_dict(data, type="pairs") %}
